...
| Event | When | Use |
|-------|------|-----|
| `Proxy:Shared:RegisterReady` | Proxy system ready | Register your components |
| `Proxy:Shared:ExtendReady` | A component registered/extended | React to component changes |
| `Core:Shared:Ready` | All core components loaded | Fetch dependencies, start logic |

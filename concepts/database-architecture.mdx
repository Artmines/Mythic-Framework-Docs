...
After `RetrieveComponents()`, use `Database.Game:method()` directly. The full path is `COMPONENTS.Database.Game` but the local shorthand is standard.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Database API" icon="code" href="/api/core/database">
    Database API reference
  </Card>
  <Card title="Architecture" icon="diagram-project" href="/concepts/architecture">
    Framework architecture overview
  </Card>
  <Card title="Configuration" icon="gear" href="/configuration/database-connections">

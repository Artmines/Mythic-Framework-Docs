...
<div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            marginBottom: '16px',
            color: '#36A3EC'
          }}><Icon icon="gamepad-2" size={48} /></div>
          <h3 style={{
            fontSize: '1.5rem',
            fontWeight: '700',
            marginBottom: '12px',
  ...
  <div style={{
    ...
    <div style={{
      ...
      <a href="https://discord.gg/mythicframework" style={{ textDecoration: 'none' }}>
        <button style={{
          padding: '18px 56px',
          fontSize: '1.3rem',
          fontWeight: '700',
  ...
  <div style={{
    ...
    <div style={{ marginTop: '16px', display: 'flex', gap: '24px', justifyContent: 'center' }}>
      <a href="https://github.com/mythicframework" style={{ color: '#36A3EC', textDecoration: 'none' }}>GitHub</a>
      <a href="https://discord.gg/mythicframework" style={{ color: '#36A3EC', textDecoration: 'none' }}>Discord</a>

...
<Accordion title="Running as Background Service (Optional)">
...
<Tip>
The server console will automatically display any errors or warnings. If resources fail to start or databases can't connect, error messages will be shown in red. For troubleshooting, see the [Troubleshooting Guide](/installation/troubleshooting).
</Tip>
...
<Steps>
  <Step title="Ensure Firewall Port is Open">
